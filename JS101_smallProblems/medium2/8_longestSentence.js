...
function longestSentence (inputText) {
  let reg = /[!.?]/g;
  let sentenceSplit = inputText.split(reg);
  let biggestSentence = "";
  //console.log(sentenceSplit);
  sentenceSplit.forEach(sentence => {
    let sentenceSplit = sentence.split(" ");
    if (sentenceSplit.length > biggestSentence.split(" ").length) {
      biggestSentence = sentence;
    }
  });
  console.log(biggestSentence);
  console.log(biggestSentence.split(" ").length);
}
